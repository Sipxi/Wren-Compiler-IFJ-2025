...
/**
 * Просматривает следующий токен в исходном коде без его потребления.
 *
 * Эта функция читает следующий токен из предоставленного файла
 * и возвращает его, не изменяя состояние лексера.
 *
 * @param lexer Указатель на структуру Lexer.
