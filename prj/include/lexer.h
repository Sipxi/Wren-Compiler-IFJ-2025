...
/**
 * Возвращает последний прочитанный токен обратно в поток.
 *
 * Эта функция позволяет "отменить" последний вызов get_token,
 * возвращая текущий токен обратно в поток для повторного чтения.
 *
 * @param lexer Указатель на структуру Lexer.
 * @param file Указатель на файл, содержащий исходный код.
 */
